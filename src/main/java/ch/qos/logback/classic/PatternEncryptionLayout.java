...
import ch.qos.logback.classic.pattern.MessageEncryptionConverter;
...
public class PatternEncryptionLayout extends PatternLayoutBase<ILoggingEvent> {
    ...
    static {
        ...
        defaultConverterMap.put("m", MessageEncryptionConverter.class.getName());
        defaultConverterMap.put("msg", MessageEncryptionConverter.class.getName());
        defaultConverterMap.put("message", MessageEncryptionConverter.class.getName());
    ...
    public PatternEncryptionLayout() {
